...
export default function Privacy() {
    useEffect(() => {
        document.title = "Privacy | Zakibot Platform";
    }, []);
            ...
            <main className="relative z-10 max-w-4xl mx-auto px-8 py-24">
                ...
                <div className="space-y-16">
                    ...
                    <section className="group">
                        ...
                        <p className="text-gray-400 text-lg leading-relaxed font-medium">
                            Your agent neural networks and configurations are stored in isolated encrypted volumes. Zakibot does not inspect the logic of your agent's private directory or monitor its internal directives unless required by global law.
                        </p>
                    </section>
