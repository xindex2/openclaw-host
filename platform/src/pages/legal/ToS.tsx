...
export default function ToS() {
    useEffect(() => {
        document.title = "Terms | Zakibot Platform";
    }, []);
                ...
                <div className="space-y-16">
                    <section className="group">
                        ...
                        <p className="text-gray-400 text-lg leading-relaxed font-medium">
                            Zakibot provides infrastructure and professional hosting services for the Zakibot agent project.
                    ...
                    <section className="group">
                        ...
                        <p className="text-gray-400 text-lg leading-relaxed font-medium">
                            By interfacing with the Zakibot Terminal, you agree to comply with these Terms of Engagement.
                    ...
                    <section className="group">
                        ...
                        <p className="text-gray-400 text-lg leading-relaxed font-medium">
                            Zakibot is provided "as is" and "as available". We are not liable for any logical data decay, agent downtime, or indirect damages resulting from system utilization.
                        </p>
                    </section>
